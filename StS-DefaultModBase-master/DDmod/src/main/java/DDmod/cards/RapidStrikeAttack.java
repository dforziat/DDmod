...
public class RapidStrikeAttack extends CustomCard {
    ...
    private static final int MAGIC_NUMBER = 4; //could change to increase number of attacks per upgrade
    private static final int UPGRADE_PLUS_MAGIC = 1;
    private static final int UPGRADE_PLUS_DMG = 1;

    // /STAT DECLARATION/

    public RapidStrikeAttack() {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        for(int i = 0; i < this.magicNumber; ++i) {
            if(i % 2 ==0) { //change animation for style
